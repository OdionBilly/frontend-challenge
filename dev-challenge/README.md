...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/0m9ST90RcS)
...
```sh
npx nx serve dev-challenge
```

To create a production bundle:

```sh
npx nx build dev-challenge
```

To see all available targets to run for a project, run:

```sh
npx nx show project dev-challenge
```
